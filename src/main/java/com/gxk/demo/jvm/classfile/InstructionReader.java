...
import com.gxk.demo.jvm.instruction.*;
...
import static com.gxk.demo.jvm.classfile.ConstantPoolInfoEnum.*;

public abstract class InstructionReader {

  public static Instruction read(int opCode, MyDataInputStream stm, ConstantPool constantPool) throws IOException {
    switch (opCode) {
      case 0x0:
        return new NopInst();
      case 0x1:
